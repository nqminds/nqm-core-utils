...
exports.shortHash = exports.splitTDXResource = exports.splitTDXAccount = exports.schemaUtils = exports.resourceUtils = exports.parseFunction = exports.padNumber = exports.makeTDXResource = exports.makeTDXAccount = exports.isNumeric = exports.isHostNameValid = exports.isDateValid = exports.isEmailValid = exports.shortId = exports.flattenJSON = exports.databotUtils = exports.constants = exports.buildDataKey = undefined;
...
var makeTDXResource = function makeTDXResource(resource, tdx) {
  if ((typeof resource === "undefined" ? "undefined" : _typeof(resource)) === "object") {
    var ownerAccount = splitTDXAccount(resource.owner);
...
var splitTDXResource = function splitTDXResource(resourceId) {
   ...
   */
  var result = void 0;
  var split = resourceId.toLowerCase().split("/");
  if (split.length === 2) {
