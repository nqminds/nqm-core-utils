(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("lodash"), require("debug"), require("mongo-parse"));
	else if(typeof define === 'function' && define.amd)
		define("nqm-core-utils", ["_", "debug", "mongo-parse"], factory);
	else if(typeof exports === 'object')
		exports["nqm-core-utils"] = factory(require("lodash"), require("debug"), require("mongo-parse"));
	else
		root["nqm-core-utils"] = factory(root["_"], root["debug"], root["mongo-parse"]);
...
var pureResourceTypes = [_constants2.default.databotBaseType, _constants2.default.groupResourceType, _constants2.default.rawFileResourceType];
...
exports.shortHash = exports.parseFunction = exports.splitTDXAccount = exports.padNumber = exports.makeTDXAccount = exports.isNumeric = exports.isHostNameValid = exports.isDateValid = exports.isEmailValid = exports.buildDataKey = exports.flattenJSON = exports.schemaUtils = exports.databotUtils = exports.resourceUtils = exports.constants = undefined;
