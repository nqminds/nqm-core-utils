...
var getAccountRootId = function getAccountRootId(accountId) {
  return _shortHash2.default.unique(_constants2.default.rootFolderPrefix + accountId);
};

var getResourceRootId = function getResourceRootId(accountId) {
  return _shortHash2.default.unique(_constants2.default.resourceRootFolderPrefix + accountId);
};

var getApplicationRootId = function getApplicationRootId(accountId) {
  return _shortHash2.default.unique(_constants2.default.applicationRootFolderPrefix + accountId);
};

var getDatabotRootId = function getDatabotRootId(accountId) {
  return _shortHash2.default.unique(_constants2.default.databotRootFolderPrefix + accountId);
};
