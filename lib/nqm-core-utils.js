...
var isApplicationDefinition = function isApplicationDefinition(resource) {
  return isResourceType(resource, _constants2.default.tdx.applicationDefinitionResourceType);
};
...
var isDataset = function isDataset(resource) {
  return isResourceType(resource, _constants2.default.tdx.datasetResourceType);
};

var isDatasetOrRawFile = function isDatasetOrRawFile(resource) {
  var datasetOrRaw = [_constants2.default.tdx.datasetResourceType, _constants2.default.tdx.rawFileResourceType];
  return isResourceType(resource, datasetOrRaw);
};

var isGeoJSON = function isGeoJSON(resource) {
  return isResourceType(resource, _constants2.default.tdx.geojsonResourceType);
};
...
var isSchema = function isSchema(resource) {
  return isResourceType(resource, _constants2.default.tdx.schemaResourceType);
};

var isVocabulary = function isVocabulary(resource) {
  return isResourceType(resource, _constants2.default.tdx.vocabularyResourceType);
};
...
exports.shortHash = exports.unCamelCase = exports.splitTDXResource = exports.splitTDXAccount = exports.slugify = exports.shortId = exports.schemaUtils = exports.resourceUtils = exports.parseTDXError = exports.parseFunction = exports.padNumber = exports.makeTDXResource = exports.makeTDXAccount = exports.isNumeric = exports.isHostNameValid = exports.isDateValid = exports.isEmailValid = exports.flattenJSON = exports.databotUtils = exports.constants = exports.buildDataKey = undefined;
 ...
 */
var makeTDXResource = function makeTDXResource(resource, tdx) {
 ...
 */
var splitTDXResource = function splitTDXResource(resourceId) {
  /*
   */
  var result = void 0;
...
exports.makeTDXResource = makeTDXResource;
...
exports.splitTDXResource = splitTDXResource;
