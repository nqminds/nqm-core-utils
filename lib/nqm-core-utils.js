...
var vocabTypeLookup = function vocabTypeLookup(vocab, id) {
...
var definitionToMongoose = function definitionToMongoose(vocab, name, tdxSchema) {
  ...
  var errList = [];
  var mongooseSchema = _schemaToMongoose(vocab, tdxSchema.dataSchema, errList, false);
  if (errList.length) {
